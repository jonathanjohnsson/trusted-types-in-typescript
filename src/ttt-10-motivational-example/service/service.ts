import { JobStatus } from '../validation/validation';
...
export class Database {
  ...
  setStatus(_id: string, _status: boolean): void {
    ...
    // and not something else, possibly malicious?
  }
}
