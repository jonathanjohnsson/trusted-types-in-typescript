...
enum IdBrand { }
export type Id = string & { brand: IdBrand }; // length 8, no spaces
//export type Id = string & IdBrand; // can't brand this way with primitive types, becomes "never"
...
enum IdBrand2 {}
export type OtherId3 = string & { brand: IdBrand2 };
